...
@Component({
  selector: 'app-sales-and-revenue',
  standalone: true,
  imports: [
    NgbDropdownModule,
    FormsModule,
  ...
  templateUrl: './sales-and-revenue.component.html',
  styleUrl: './sales-and-revenue.component.scss'
})
export class SalesAndRevenueComponent {
  /**
    * NgbDatepicker
    */
  ...
  public barChartData: ChartData<'bar'> = {
    labels: ["Drinks", "Vegetables", "Papers", "Spaggeti", "Fruits","Drinks", "Vegetables", "Papers", "Spaggeti", "Fruits"],
    datasets: [
      {
        label: "Products",
        ...
        data: [2478, 5267, 734, 2084, 1433,2478, 5267, 734, 2084, 1433 ],
      }
    ],
  };
  /**
  ...
  public groupedBarChartData: ChartData<'bar'> = {
    labels: ["Μαρούλι", "Καφές", "Ζαχαρη", "Παπρικα"],
    datasets: [
      {
        label: "Ληγμένα",
